...
export default class Grass {
    ...
    update() {
        ...
        if (aChunkState && aChunkState.terrain && aChunkState.terrain.renderInstance) {
            // Texture A
            ...
            if (bChunkSate && bChunkSate.terrain && bChunkSate.terrain.renderInstance) {
            ...
            if (cChunkSate && cChunkSate.terrain && cChunkSate.terrain.renderInstance) {
            ...
            if (bChunkSate) {
                ...
                if (dChunkSate && dChunkSate.terrain && dChunkSate.terrain.renderInstance) {
