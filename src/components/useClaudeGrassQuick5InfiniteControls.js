...
export default function useClaudeGrassQuick5InfiniteControls() {
  const controls = useControls("🌿 FOLIAGE Infinite", {
    claudeGrassQuick5Infinite: folder(
      {
        // Master toggle
        enabled: {
          value: false,
          label: "🌿 Enable Claude Grass Quick 5 Infinite",
        },
        ...
        grassDistance: {
          ...
          max: 200,
          step: 5,
          label: "📏 Grass Distance (Wrap Size)",
        },
